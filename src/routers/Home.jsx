    ...
    <>
      ...
      <div className='bg-zinc-100 mx-auto max-w-5xl rounded-xl p-10 my-10' style={{ color: "#383838" }}>
        ...
        <div className='flex items-center pt-5 gap-5 flex-wrap'>
          <a className="grayscale hover:grayscale-0 md:opacity-50 md:hover:opacity-100 m-0 p-0 md:w-1/6" href="https://sites.google.com/gs.ncku.edu.tw/yungscpl" target="_blank"><img src={logo_CPL} title="國立成功大學燃燒與推進實驗室" /></a>
          
          <a className="grayscale hover:grayscale-0 md:opacity-50 md:hover:opacity-100 m-0 p-0 md:w-1/5" href="https://hackmd.io/" target="_blank"><img src={logo_HackMD} title="HackMD" /></a>
        </div>
      </div>
    </>
  );
