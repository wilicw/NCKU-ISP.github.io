function About() {
  return (
    <>
      ...
      <div className='bg-zinc-100 mx-auto max-w-5xl rounded-xl p-10 my-10' style={{ color: "#383838" }}>
        <p className='text-3xl font-bold pb-2'>加入我們</p>
        <hr className="border-blue-300 w-10 border-b-2" />
        ...
        <p className="block pb-5">
          ISP 火箭是全台第一支開源火箭！這是一個總部在成功大學，全國皆可參與的教育性火箭計畫，許多教育機構也是我們的合作夥伴，如台灣大學、中央大學，以及一些國高中。
          <br /><br />
        ...
        <p className="block pb-5">
          1960 年代以來，不論哪個國家，航太科技都屬於政府機密保護範圍。隨著時代變遷，近十年來由SpaceX領頭，全球已有上千家航太新創正在發展，使得研究漸漸與軍事脫鉤，開始走入商業領域。
          <br /><br />
          2008 年太空中心正式啟動混合式探空火箭研發計畫，給予成功大學與交通大學（現陽明交通大學）兩個團隊、另外成大及中央大學也曾多次參與太空任務的酬載開發，前述即為國內主要鑽研航太領域的三間學校。無奈若非三校學生，對相關知識仍難以獲取。
          <br /><br />
          ISP 團隊體認到繁體中文圈內對知識來源的缺乏，也認為開源是對於教育的正確道路，因此ISP 團隊非常認真看待計畫開源這件事。
          <br /><br />
